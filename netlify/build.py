...
hanko_url = os.environ.get(
    "HANKO_URL", "https://e3c4803f-48cc-4b62-9ac5-2aa02444ba51.hanko.io"
)
...
redirects = ["auth", "chatlist.json", "connect", "new_chat", "update_profile", "chats/"]
netlify = ""
